    ...
    switch ($accion) {
        ...
        case "nusuario":
			...
			//////////////*******************************Caso para el usuario aceptado
				...
				$ultimoNum = $rspNumInfo->id_usuario;
				...
				mkdir("../contenedor/clientes/".$rfcR."/", 0755);
				//creamos la carpeta para meter las cotizaciones
				mkdir("../contenedor/clientes/".$rfcR."/cotizaciones", 0755);
				//creamos la carpeta para meter las facturas
				mkdir("../contenedor/clientes/".$rfcR."/facturas", 0755);
				//creamos la carpeta para meter los tickets
				mkdir("../contenedor/clientes/".$rfcR."/tickets", 0755);
				//carpeta para proveedores
				mkdir("../contenedor/clientes/".$rfcR."/proveedores", 0755);
				

				/* Creamos el movimiento para los ticket */
				$pritic = 1;
				$tke = $rweb->unotic($pritic,$ultimoNum,$fechaAccion);
		        ...
		        try {
		                ...
		                $mail->setFrom('registro@massiva.mx', 'Registro plataforma');
		                $mail->addAddress($hola, 'Cliente');     // Add a recipient
		                $mail->addAddress('registro@massiva.mx','Registro plataforma');               // Name is optional
						...
						<!DOCTYPE html>
							...
							<body>
								...
								<table align='center' cellpadding='0' cellspacing='0' width='500' style='border-collapse: collapse;'>
									...
									<tr><td><br></td></tr>
									<tr>
										<td colspan='2' style='align-content: center' face='arial'><font face='arial'><h1 style='align-items: center;' face='arial'>¡Bienvenido a massiva!</h1></font></td>
									</tr>
									<tr>
										<td colspan='2'>
										<br>
									...
									<tr>
										<td colspan='2'>
										<br>
											<font color='gray' face='arial'>Si tienes dudas o requieres apoyo, contacta con <a href='mailto:atencionclientes@massiva.mx'>atencionclientes@massiva.mx</a></font>
										</td>
									</tr>
									<tr><td></td></tr>
									<tr>
										<td colspan='2' style='align-content: center' face='arial' valign='middle'><font face='arial' color='gray'><small face='arial'>
										<br>
										Atentamente:<br>El equipo de massiva<br><br>Massiva protegerá siempre tu privacidad y confidencialidad de datos.<br> Si quieres saber más, revisa el Aviso de Privacidad y en Términos y Condiciones dentro de www.massiva.mx</small></font></td>
									</tr>
									<tr><td><br></td></tr>
									<tr>
									<br>
