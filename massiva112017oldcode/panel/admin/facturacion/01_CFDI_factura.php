...
### 6. ARRAYS QUE CONTIENEN LOS ARTICULOS QUE FORMAN PARTE DE LA VENTA #####################
    ...
    $Array_ClaveProdServ    = ['23241610', '20142900', '31151600', '50202300']; // 6.1 Clave del SAT correspondiente al artículo o servicio (consultar el catálogo de productos del SAT).
    $Array_NoIdentificacion = ['CORCOB', 'TANQG-BUT', 'CADGALV', 'AGUA-ENB'];    // 6.2 Clave asignada al artículo o servicio, sistema local.
    $Array_Cantidad         = ['5', '3', '3.5', '5'];                           // 6.3 Cantidad.
    $Array_ClaveUnidad      = ['H87', 'H87', 'LM', 'K62'];                      // 6.4 Clave del SAT correspondiente a la unidad de medida (consultar el catálogo de productos del SAT).
    $Array_Unidad           = ['PIEZA', 'PIEZA', 'METRO', 'LITRO'];             // 6.5 Descripción de la unidad de medida.
    $Array_Descripcion      = ['CORTADOR DE TUBO DE COBRE', 'TANQUE CON GAS BUTANO', 'CADENA GALVANIZADA, TAMAÑO MEDIANO', 'AGUA ENBOTELLADA']; // 6.6 Descripción del artículo o servicio.
    $Array_ValorUnitario    = ['125.50', '35.80', '131.00', '10.00'];              // 6.7 Valor unitario del artículo o servicio.
    $Array_Importe          = ['627.50', '107.40', '458.50', '50.00'];          // 6.8 Importe del artículo o servicio.
    $Array_Descuento        = ['0', '0', '0', '0'];                             // 6.9 Descuento aplicado al artículo o servicio.
