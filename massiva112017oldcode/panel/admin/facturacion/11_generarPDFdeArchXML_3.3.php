...
$NomArchXML       = "CFDI_3.3_Factura.xml"; // Nombre del archivo .XML correspondiente a un CFDI versión 3.3
$NomArchPDF       = "CFDI_3.3_Factura.pdf"; // Nombre del archivo .PDF que se construirá.
