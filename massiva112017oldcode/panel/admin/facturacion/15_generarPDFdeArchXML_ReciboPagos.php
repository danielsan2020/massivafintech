...
$NomArchXML       = "CFDI_3.3_ReciboPagos.xml"; // Nombre del archivo .XML correspondiente a un CFDI versión 3.2
$NomArchPDF       = "CFDI_3.3_ReciboPagos.pdf"; // Nombre del archivo .PDF que se construirá.
