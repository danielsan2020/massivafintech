<?php
/* otbenemos valores del usuario para guardar la informacion */
@session_start();
$rfc = $_SESSION['rfc'];
...
$SendaArchsCFDI = "$archiv_cer = '../contenedor/clientes/".$rfc."/facturas";
...
####### ENCABEZADO DE LA FACTURA #############################################################
    ...
    $pdf->SetTextColor(247,189,0);
    $pdf->SetFont('arial','B',13);
    $pdf->SetXY($X+10.5,$Y+1.25+0.1);
    $pdf->Cell(1.5, 0.25, "FACTURA.", 0, 1,'L', 0);
