...
//        if (strlen($params->item($k)->getAttribute('nombre'))>0){
//            $Emisor_nombre = $params->item($k)->getAttribute('nombre');
//        }
//
//        if (strlen($params->item($k)->getAttribute('rfc'))>0){
//            $Emisor_RFC = $params->item($k)->getAttribute('rfc');
//        }
//
//        if (strlen($params->item($k)->getAttribute('RegistroPatronal'))>0){
//            $Emisor_RegistroPatronal = $params->item($k)->getAttribute('RegistroPatronal');
//        }
//
//        if (strlen($params->item($k)->getAttribute('RfcPatronOrigen'))>0){
//            $Emisor_RfcPatronOrigen = $params->item($k)->getAttribute('RfcPatronOrigen');
//        }
//
//        $k++;
//    }    

//    $params = $DocXML->getElementsByTagName('RegimenFiscal');
//    foreach ($params as $param) {
//           
//    }    
...
$pdf->SetFillColor(0,0,0);
    ...
    $pdf->image("archs_graf/LogoSAT.jpg",$X+16.8, $Y+3.6 , 0, 0);
...
//    $pdf->Cell(1, 0.35, NumLet($total), 0, 1,'L', 0);
//
//}
