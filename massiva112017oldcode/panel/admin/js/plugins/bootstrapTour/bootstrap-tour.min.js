        ...
        (this._options = t.extend(
          {
            ...
            basePath: "",
            template:
              '<div class="popover" role="tooltip" style="backgorund-color:#eac52d"><div class="arrow"></div> <h3 class="popover-title" sty></h3> <div class="popover-content"></div> <div class="popover-navigation"> <div class="btn-group"> <button class="btn btn-sm btn-default" data-role="prev">&laquo; Anterior</button> <button class="btn btn-sm btn-default" data-role="next">Siguiente &raquo;</button> <button class="btn btn-sm btn-default" data-role="pause-resume" data-pause-text="Pause" data-resume-text="Resume">Pausar</button> </div> <button class="btn btn-sm btn-default" data-role="end">Terminar</button> </div> </div>',
      ...
      return (
        ...
        (o.prototype.hideStep = function(e) {
          ...
          return (i = this.getStep(e))
            ? (this._clearTimer(),
              (n = this._makePromise(
                null != i.onHide ? i.onHide(this, e) : void 0
              )),
              (o = (function(o) {
                return function() {
                  var n;
        ...
        (o.prototype.showStep = function(t) {
          ...
          return this.ended()
            ...
            ? ((r = t < this._current),
              (o = this._makePromise(
                null != s.onShow ? s.onShow(this, t) : void 0
              )),
              (i = (function(e) {
                return function() {
                  var o, i, a;
                  ...
                  return (
                    s.backdrop &&
                      e._showBackdrop(e._isOrphan(s) ? void 0 : s.element),
                    (a = function() {
                      return e.getCurrentStep() === t
                        ? (null != s.element &&
                            s.backdrop &&
                            e._showOverlayElement(s),
                          e._showPopover(s, t),
        ...
        (o.prototype._isRedirect = function(t, e) {
          return (
            null != t &&
            "" !== t &&
            (("[object RegExp]" === {}.toString.call(t) && !t.test(e)) ||
        ...
        (o.prototype._redirect = function(e, o) {
          return t.isFunction(e.redirect)
            ? e.redirect.call(this, o)
            : e.redirect === !0
            ? (this._debug("Redirect to " + o), (n.location.href = o))
            : void 0;
        }),
        ...
        (o.prototype._showBackdrop = function() {
          return this.backdrop.backgroundShown
            ? void 0
          ...
          return (
            ...
            o && 0 !== o.length && !this.backdrop.overlayElementShown
              ? ((this.backdrop.overlayElementShown = !0),
                ...
                e.backdropPadding &&
                  (n = this._applyBackdropPadding(e.backdropPadding, n)),
