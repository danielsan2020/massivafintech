...
$(document).ready(function() {
  ...
  /**********************************************************************************************/
  /****************************************Seccion para la actulizaciones de obligaciones************************************/

  /* para abrir modal de comprar */
  $("#nuevoClienteC").on("show.bs.modal", function(event) {
    var button = $(event.relatedTarget); // Button that triggered the modal
    var uno = button.data("unoo");
    var modal = $(this);
    modal.find(".modal-body #costo").val(uno);
  });
  ...
  $("#nuevoActivobtn").click(function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        $("#alertAccion").append(
          '<div class="alert alert-success text-center">Se agrego su nuevo activo</div>'
        );
  ...
  $("#monto").blur(function() {
    ...
    if (fechaCompra == "") {
      alert(
        "Para el cálculo automático de la depreciación recuerda llenar la fecha de compra y el monto"
      );
    } else {
  ...
  $("#btnElimina").click(function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        $("#alertAccion").append(
          '<div class="alert alert-success text-center">Se elimino el activo</div>'
        );
  ...
  $("#editarSeguro").click(function() {
    ...
    $.ajax({
      ...
      success: function(response) {
        $("#alertAccion").append(
          '<div class="alert alert-success text-center">Se agrego su nuevo seguro</div>'
        );
