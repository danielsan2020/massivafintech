...
$twxt = "<b>CONTRATO DE RESPONSIVA Y PRESTACIÓN DE SERVICIOS</b> (el 'Contrato') que celebran, por una parte, <b>MASSIVA CONTABILIDAD INNOVADORA SOCIEDAD CIVIL 
	'MASSIVA'</b>, ( ".$nombre.", con la forma jurídica de Persona ".$tipo.", RFC: ".$rfc."), y conjuntamente, las 'Partes' e indistintamente una 'Parte', al tenor de las siguientes declaraciones:<br>
...
$archivoCambiar = "contenedor/clientes/".$rfc."/".$rfc."_AcuerdoEntregaEfirmaDocumentosFiscales.pdf";
...
<body>
    ...
    <div class="gray-bg dashbard-1">
		...
		<div class='row text-center'><div class="alert alert-warning">Por tu seguridad y control validamos toda tu información proporcionada ya que será de suma importancia.<br> <b>Recuerda que tus archivos deben de pesar menos de 2 MB.</b></div></div>
			...
			<div class="col-md-6">
                <div class="ibox">
                    ...
                    <div class="ibox-content text-center">
						<embed src="contenedor/clientes/<?=$rfc?>/<?=$rfc?>_AcuerdoEntregaEfirmaDocumentosFiscales.pdf" type="application/pdf" width="100%" height="600">
                    ...
                    <div class="ibox-content">
						<form action='controlador/documentacionpre.php' method='POST'  enctype="multipart/form-data">
							...
							<div class="input-group m-b">
								...
								<input type="file" placeholder="Username" name='iden2' id='iden2' class="form-control">
							</div>
							<hr>
							...
							<hr>
							<div class="input-group m-b">
								<span class="input-group-addon">e.firma .CER <img src='img/CER.png' style='height:20px;'></span> 
