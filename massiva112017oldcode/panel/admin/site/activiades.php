		...
		<div class="widget style1 navy-bg">
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					<span> Cuantos clientes tengo </span>
	...
	<div class="col-lg-3">
		<div class="widget style1 navy-bg" style="background-color: #878991 !important">
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					<span> Cuantas facturas tengo </span>
	...
	<div class="col-lg-3">
		<div class="widget style1 navy-bg">
			<div class="row">
				...
				<div class="col-xs-8 text-right">
					<span> Cuantas cotizaciones tengo </span>
					<h2 class="font-bold">26</h2>
				</div>
			</div>
		</div>
                                ...
                                <div class="ibox-content">
                                    <div>
                                        ...
                                        <h4>NYS report new data!
                                            <br/>
                                            <small class="m-r"><a href="../estructura/graph_flot.html"> Check the stock price! </a> </small>
                                        </h4>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div>
                                            <div class="feed-activity-list">
                                                ...
                                                <div class="feed-element">
                                                    <a href="../estructura/profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="../estructura/img/profile.jpg">
                                                    </a>
                                                ...
                                                <div class="feed-element">
                                                    <a href="../estructura/profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="../estructura/img/a2.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="../estructura/profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="../estructura/img/a3.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="../estructura/profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="../estructura/img/a4.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                ...
                                                <div class="feed-element">
                                                    <a href="../estructura/profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="../estructura/img/a5.jpg">
                                                    </a>
                                                    <div class="media-body ">
                                                        <small class="pull-right">2h ago</small>
                                                ...
                                                <div class="feed-element">
                                                    <a href="../estructura/profile.html" class="pull-left">
                                                        <img alt="image" class="img-circle" src="../estructura/img/a7.jpg">
                                                    </a>
                                                    <div class="media-body ">
