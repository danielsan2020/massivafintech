...
<div class="row">
	<div class="col-md-12" >
		<?php if($EnviCoDOs == 2){?>
			<div class="alert alert-warning text-center">Se finalizo el saneamiento de la contabilidad del usuario</div>
		<?php }?>
	</div>
</div>
								...
								?>
									<tr>
										...
										<td class="text-center">
											<div class="col-md-12"><button type="submit" class="btn btn-primary" data-toggle="modal" data-target="#myModal" data-unoo='<?php echo $vriId;?>'  data-fdod='<?php echo $unoInfo->rfc;?>' data-cuatro='<?php echo $unoInfo->id_usuario;?>' data-tres='<?php echo $unoInfo->correo;?>'><i class="fa fa-edit"></i></button></div>
										</td>
										<?php }else{?>
											<td class="text-center">
												<div class="col-md-12"><b>Finalizado</b></div>
											</td>
										<?php }?>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		   ...
		   <div class="panel-body">
					<form class="input-group" action="controlador/simuladorControlador.php" style="width: 100% !important" method="POST" enctype="multipart/form-data">
						<input type="hidden" class="form-control" name="accion" id="accion" value='finalizaConta'>
      ...
      <div class="modal-footer">
		<button type="submit" class="btn btn-primary">Terminar  y Enviar</button>
