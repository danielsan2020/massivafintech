...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-12">
		<div class="title-action">
			...
			<a href="index.php?secc=inventarioGeneral" class="btn btn-primary"> Regresar</a>
		</div>
	</div>
</div>
<div class="row">
	...
	<div class="col-lg-12">
		<div class="tabs-container">
			<ul class="nav nav-tabs">
				<li class="active"><a data-toggle="tab" href="#tab-1" aria-expanded="false">Facturas sin asignar </a></li>
				<li class=""><a data-toggle="tab" href="#tab-2" aria-expanded="true">Facturas asignadas a proveedores</a></li>
			</ul>
									...
									<table class="table table-striped table-bordered table-hover dataTables-example" >
										...
										<tbody>
											...
											<th class="text-center">
												...
												<a href="" class="btn btn-primary" data-toggle="modal" data-target="#cobro" title="Pago"><i class="fa fa-money"></i></a>
												<a href="" class="btn btn-primary" data-toggle="modal" data-target="#nuevoprodu" title="Descargar"><i class="fa fa-download"></i></a>
												<a href="" class="btn btn-primary" data-toggle="modal" data-target="#reenviar" title="Enviar"><i class="fa fa-send"></i></a>
											...
											<th class="text-center">
												...
												<a href="" class="btn btn-default" data-toggle="modal" data-target="#vdes" title="Descuento"><i class="fa fa-tags"></i></a>
												<!--aplica verificando del xml apartir de los 800 en calve de sat se bloquea-->
												<a href="" class="btn btn-default" data-toggle="modal" data-target="#devolucion" title="Devolución"><i class="fa fa-truck"></i></a>
												<a href="" class="btn btn-default" data-toggle="modal" data-target="#nuevoprodu" title="Pago"><i class="fa fa-money"></i></a>
