					...
					<tbody>
						<tr>
							...
							<th class="text-center">
								<a href="index.php?secc=resumenDecla" class="btn btn-primary" > Declaración mensual</a>
								...
								<a href="#" class="btn btn-primary" > Liberar</a><!--se libera y se pasa a la secciond e declaracion del usuario--->
							</th>
						</tr>
					</tbody>
				</table>
