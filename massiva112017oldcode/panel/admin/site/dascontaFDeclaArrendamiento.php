...
<div class="row wrapper border-bottom page-heading">
	<div class="row">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title"> <h5>Declaraciones | Arrendamiento</h5></div>
					...
					<tbody>
						<tr>
							...
							<th class="text-center">
								<a href="index.php?secc=resumenDeclaArrendamiento" class="btn btn-primary" > Declaración mensual</a>
								<a href="index.php?secc=resumenDeclaArrendamientoAnual" class="btn btn-primary" > Declaración Anual</a>
