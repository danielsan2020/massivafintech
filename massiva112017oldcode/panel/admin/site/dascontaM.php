                                         ...
                                         <ul class="sortable-list connectList agile-list" id="todo">
					                        <li class="warning-element" id="task1">
					                            ...
					                            <div class="agile-detail">
					                                <a href="index.php?secc=dascontaMDecla" class="pull-right btn btn-xs btn-primary">Atender</a>
        ...
        <div class="col-lg-6">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <button type="button" class="btn btn-outline btn-default"><b>Solicitudes sin registro total: </b> 10,000 </button>
                    <button type="button" class="btn btn-outline btn-default"><b>Solicitudes registrados total: </b> 10,000 </button>
                    <button type="button" class="btn btn-outline btn-default"><b>Solicitudes ejecutando total: </b> 10,000 </button>
                    
                    <ul class="sortable-list connectList agile-list" id="inprogress">
                       <li class="warning-element" id="task1">
                            HEVA870404MP6
                            <div class="agile-detail">
                                <a href="index.php?secc=contaatrasasM" class="pull-right btn btn-xs btn-primary">Atender</a>
                                <i class="fa fa-clock-o"></i> 12.10.2015
                            </div>
                        </li>
                        <li class="warning-element" id="task1">
