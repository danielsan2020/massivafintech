...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-12">
		<div class="title-action">
			<a href="index.php?secc=inventario" class="btn btn-primary" > Regresar</a>
...
<div class="wrapper wrapper-content animated fadeInRight">
	<div class="row">
		...
		<div class="ibox float-e-margins">
			<div class="ibox-title"> <h5>Reporte general</h5></div>
				...
				<table class="table table-striped table-bordered table-hover" >
					...
					<tbody>
						<?php while($rspTablaInfo = $rspTabla->fetch_object()){ ?>
								<tr class="gradeX">
									<td align="center"><img src="contenedor/inventarioActivos/<?= $rspTablaInfo->imagen;?>" style="height: 50px;" class="img-rounded"></td>
									<td><?= $rspTablaInfo->nombre;?></td>
									<td><?= $rspTablaInfo->codigo;?></td>
									<td><?= $rspTablaInfo->cantidad;?></td>
									<td>
										<b>Descripción:</b> <?= $rspTablaInfo->descripcion;?><br>
										<b>Ubicación:</b> <?= $rspTablaInfo->ubicacion;?><br>
										<b>Código:</b> <?= $rspTablaInfo->codigo;?><br>
										<b>Precio venta:</b> <?= $rspTablaInfo->precioFinal;?><br>
										<b>Descuento:</b> <?= $rspTablaInfo->descuentos;?><br>
										<b>proveedor:</b> <?= $rspTablaInfo->proveedor;?><br>
										<b>Precio compra:</b> <?= $rspTablaInfo->precio;?><br>
									</td>
								</tr>
									...
									<td colspan="2">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover">
												...
												<?php 
													$consEntra = $invactivo->consEntra($rspTablaInfo->idInventario);
									...
									<td colspan="2">
										<div class="table-responsive">
											<table class="table table-striped table-bordered table-hover">
												...
												<!--consulta de salidas-->
												<?php 
													$consSalidas = $invactivo->consSalidas($rspTablaInfo->idInventario);
													while($consSalidasInfo = $consSalidas->fetch_object()){
												?>
												<tr>
													<td><?= $consSalidasInfo->fechaEntrada;?></td>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
    			...
    			<div class="alert alert-danger text-center">Si eliminas el producto no podrás recuperarlo.</div>
			</div>
			<div class="modal-footer">
...
<div class="modal inmodal fade" id="agregarentrada" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="titulo">Agregar</h4>
			</div>
			<div class="modal-body">
