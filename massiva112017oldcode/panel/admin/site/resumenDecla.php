...
<div class="row white-bg page-heading">
	<div class="col-md-12">
		<div class="title-action"><a href="index.php?secc=dascontaFDecla" class="btn btn-primary" > Regresar</a></div>
	</div>
</div>
<div class="row">
...
<div class="wrapper wrapper-content  animated fadeInRight">
    ...
    <div class="row">
        <div class="col-lg-3">
            ...
            <div class="ibox">
                <div class="ibox-content">
                    <h3>Total iva retenido (acumula)</h3>
                    <ul class="list-group">
                        <li class="list-group-item">
                            <span class="badge">14</span>
                            Total
    ...
    <div class="row">
        ...
        <div class="col-lg-3">
            <div class="ibox">
                <div class="ibox-content">
                    <h3>ISR retenido de periodos anteriores(acumula)</h3>
                    <ul class="list-group">
                        <li class="list-group-item">
                            <span class="badge">14</span>
                            Total (1+2-3-4)
