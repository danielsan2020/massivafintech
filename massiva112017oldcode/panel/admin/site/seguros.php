...
<div class="modal fade" id="nuevoSeguro" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header text-center"><h3 class="modal-title" id="titulo">Nuevo Seguro</h3> <button type="button" class="close" data-dismiss="modal"></button></div>
			<div class="modal-body">
				<div class="row">
					...
					<div class="col-md-6">
						<div class="input-group m-b">
							<span class="input-group-addon"><i class="fa fa-angle-right"></i></span> 
							<select class="mdb-select md-form form-control" id="tipo" name="tipo" >
								<option></option>
								<optgroup label="Personales">
    								<option value="De vida">De vida</option>
    								<option value="De accidentes pesonales">De accidentes personales</option>
									<option value="De salud o enfermedad">De salud o enfermedad</option>
									<option value="De dependencia">De dependencia</option>
									<option value="Planes de pensiones">Planes de pensiones</option>
  								</optgroup>
								<optgroup label="Daños o patrimoniales">
    								<option value="De incendios">De incendios</option>
    								<option value="De responsabilidad civil">De responsabilidad civil</option>
									<option value="De automóvil">De automóvil</option>
									<option value="Agrarios">Agrarios</option>
									<option value="De pérdidas pecuniarias">De pérdidas pecuniarias</option>
									<option value="De robo">De robo</option>
									<option value="De crédito y caución">De crédito y caución</option>
									<option value="De transportes">De transportes</option>
									<option value="De ingeniería">De ingeniería</option>
									<option value="Multirriesgos">Multirriesgos</option>
  								</optgroup>
								  <optgroup label="Prestación de servicios">
    								<option value="De defensa jurídica">De defensa jurídica</option>
    								<option value="De asistencia en viaje">De asistencia en viaje</option>
									<option value="De decesos">De decesos</option>
  								</optgroup>
							</select>
						</div>
					</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title" id="titulo">Eliminar tu seguro</h4>
			</div>
			<div class="modal-body">
				<input type="hidden" name="idSeguroEli" id="idSeguroEli">
    			<div class="alert alert-danger text-center">Si eliminas el seguro no podrás recuperarlo.</div>
			</div>
			<div class="modal-footer">
...
<div class="modal inmodal fade" id="editaseguro" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title" id="titulo">Editar seguro</h4>
			</div>
			<div class="modal-body">
				<input type="hidden" name="idSeguro1" id="idSeguro1">
				<div class="row">
					<div class="col-md-6">
						<div class="input-group m-b">
							<span class="input-group-addon"><i class="fa fa-angle-right"></i></span> 
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="input-group m-b">
							<span class="input-group-addon">Fecha de inicio del seguro</span> 
				...
				<div class="row">
					<div class="col-md-6">
						<div class="input-group m-b">
							<span class="input-group-addon">Fecha de término del seguro</span> 
