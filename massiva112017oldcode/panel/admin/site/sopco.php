<?php 
	...
	$vaTickTermin = $soporte->ticketTerminadosCon($valoId);

	//verificamos cuantos registros tiene
	$consulta = $soporte->consultasHechas($valoId);
	$consultaInfo = $consulta->fetch_object();
	$numero = $consultaInfo->numero;
...
<script src="js/vista/soporteTecnicoCon.js"></script>

<div style='background-color: #878991 !important; color:#fff' class='alert alert-secondary text-right' bg-secondary text-white><b>Número de consultas contables realizadas: <?= $numero;?></b><br><b>Recuerda que solo tienes 5 consultas mensuales</b> </div>
...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-12">
		<div class="title-action">
			<?php if($idT == ''){?>
				<?php if($numero < 5){?>
					<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#tnuevoElemento" > Nueva consulta contable</button>
				<?php }?>
			<?php }?>
...
<div class="wrapper wrapper-content">
	...
	<?php if($idT == ''){?><div class="row text-center"><div class="col-lg-12"><div class="alert alert-warning"><b>Por el momento no cuenta con ninguna consulta contable abierta.</b></div></div></div><?php }?>

	<?php if($idT != ''){?>
	<div class="row text-center">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title"><h5>Número de consulta <?= $idT;?><small class="m-l-sm">(Estatus: <?php if($rspTickInfo->estatus == 1){echo "Activo";}?>)</small></h5></div>
				<div class="ibox-content text-left">
					...
					<?php 
						...
						$resTic = $soporte->ticketsRespuesCon($idT);
					...
					<div class="row text-right">
						...
						<div class="input-group m-b">
							...
							<span class="input-group-addon">Agregar Archivo</span> 
					...
					<div class="row text-right">
						...
						<a class="btn btn-danger"  data-toggle="modal" data-target="#termina"  data-whatever="<?= $idT; ?>">Terminar consulta</a>
					</div>

				</div>
				<div class="ibox-footer text-right">
					<span class="pull-left"><b>Fecha y hora de la consulta:</b> <?= $rspTickInfo->fechaCreacion;?> </span>
					<b>Atiende:</b> Soporte contable
				</div>
			</div>
		</div>
	</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Nueva consulta contable</h4>
			...
			<input type='hidden' name='conteo' id='conteo' value='<?php echo $numero;?>'>
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id='nuevoTicket'> Generar consulta</button>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class='row'>
					<div class='col-md-12'>
						<div class="alert alert-danger text-center">¿Estás de acuerdo en terminar esta consulta?</div>
					</div>
				</div>
				<div class='row'>
					<div class='col-md-12'>
...
<div class="modal inmodal fade" id="terminados" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title">Consultas contables terminadas</h4>
			</div>
			<div class="modal-body">
								...
								<tr class="gradeX">
									...
									<td>
										<?php
											...
											$resTickREs = $soporte->ticketTerminadosCon($IdenTick);
