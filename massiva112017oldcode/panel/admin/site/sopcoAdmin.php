<?php 
	...
	$vaTickTermin = $soporte->ticketAbiertosAdminCon($valoId);
	...
	<div class="row">
		<div class="col-lg-12">
			<div class="ibox float-e-margins">
				<div class="ibox-title"><h5>Tickets contables pendientes</h5></div>
							...
							<tbody>
								...
								<tr class="gradeX">
									...
									<td class="text-center">
										...
										<input type="hidden" name="idReportar" id="idReportar" value='<?= $vaTickTerminInfo->id_soporte;?>'>
										<button class="btn btn-primary" id='envioCorreo'><i class="fa fa-paper-plane"></i></button>
										...
										<button class="btn btn-danger" data-toggle="modal" title="Terminar ticket" data-target="#complemm" data-unoo="<?= $vaTickTerminInfo->id_soporte; ?>">
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				...
				<h4 class="modal-title">Respuesta a Ticket contable</h4>
			</div>
			<!--valores ocultos-->
...
<!---modal para acabaer de complementaria--->
<div class="modal inmodal fade" id="complemm" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title">Dar solución complementaria</h4>
			</div>
			<!--valores ocultos-->
			<div class="modal-body">
				...
				<div class='row'>
					<div class='col-md-12'>
							...
							<select class="form-control" style='width:100%'>
								<option>A favor del cliente</option>
								<option>En contra del cliente</option>
			...
			<div class="modal-footer">
				<!---con esto se envia un correo--->
				<button type="button" class="btn btn-primary" id='nuevComnAd'> Terminar</button>
				<button type="button" class="btn btn-white" data-dismiss="modal" id='btnnuevoComen'> Cerrar</button>
			</div>
		</div>
	</div>
...
<div class="modal inmodal fade" id="vercomentarios" tabindex="-1" role="dialog"  aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
				<h4 class="modal-title">Comentarios del ticket contable</h4>
			</div>
			<div class="modal-body">
				<div id="InvColor"></div>
			</div>
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<div class='row'>
					<div class='col-md-12'>
						<div class="alert alert-danger text-center">¿Estás de acuerdo en terminer el ticket?</div>
					</div>
				</div>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-primary" id='terminarTickeADmin'> Terminar Ticket contable</button>
				<button type="button" class="btn btn-white" data-dismiss="modal" id='btnTern'> Cerrar</button>
			</div>
		</div>
	</div>
