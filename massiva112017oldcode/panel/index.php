...
$mensaje = $_GET['act'];
if ($mensaje == '2'){ $anuncio = "Completa tus credenciales"; }
else {$anuncio = 'Tus datos son incorrectos, prueba de nuevo por favor';}
    
?>
<!DOCTYPE html>
<html lang="es">
<head>
    <title>Massiva | acceso a plataforma</title>
    <meta charset="UTF-8">
    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100 p-t-30 p-b-50">
                ...
                <form class="login100-form validate-form p-b-33 p-t-5" action="admin/login/index.php" method="post">
                    ...
                    <div class="container-login100-form-btn m-t-32">
                        <p><a href="recuperar.php" style="cursor: pointer">Recuperar contraseña</a></p>
                    </div>
                    <?php if ($mensaje != ''){?> 
                        <div class="container-login100-form-btn m-t-32">
                            <div class="alert alert-danger text-center" role="alert"><?= $anuncio;?></div>
                        </div>
                    <?php }?>
                </form>
            </div>
