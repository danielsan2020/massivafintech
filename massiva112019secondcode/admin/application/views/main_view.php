...
<html>
    ...
    <body ng-app="app">
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>js/vendors/moment.min.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/vendors/moment.es.js"></script>
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>js/directives/numbers-only.js"></script>
        <script type="text/javascript" src="<?php echo base_url(); ?>js/filters/trust.js"></script>
        <?php if (ENVIRONMENT !== 'production') { ?>
            <span style="background-color: #ccc; border: #000 1px solid; position: fixed; bottom: 0; right: 0; padding: 10px;"><?php echo ENVIRONMENT; ?></span>
        <?php } ?>
    </body>
</html>
