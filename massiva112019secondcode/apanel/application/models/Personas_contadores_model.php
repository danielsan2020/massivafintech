...
class Personas_contadores_model extends CI_Model {
    ...
    public function get_by_id($id) {
        $this->db->select('id, jefe_id, contador_id, persona_id');
    ...
    public function get_persona_by_id($id) {
        $this->db->select('personas.rfc, personas.razon_social, personas_contadores.id, personas_contadores.jefe_id, personas.id, personas_contadores.contador_id');
        $this->db->from('personas_contadores');
        $this->db->join('personas', 'personas.id = personas_contadores.persona_id');
//        $this->db->join('datos_fiscales', 'datos_fiscales.persona_id = personas.id');
    ...
    public function get_personas_by_jefe_id_and_contador_id($jefe_id, $contador_id) {
        $this->db->select('personas.rfc, personas.razon_social, personas.id, personas.actividad');
        $this->db->from('personas_contadores');
        $this->db->join('personas', 'personas.id = personas_contadores.persona_id');
    ...
    public function get_all_declaraciones_by_jefe_contador_id_and_contador_id($jefe_id, $contador_id) {
    ...
    public function get_all_declaraciones_declaraciones_by_jefe_contador_id_and_contador_id($jefe_id, $contador_id) {
