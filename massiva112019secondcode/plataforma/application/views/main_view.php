...
<html>
    <head>
        ...
        <link href="<?php echo base_url(); ?>css/angular-moment-picker.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body ng-app="app">
        ...
        <script type="text/javascript" src="<?php echo base_url(); ?>js/modules/angular-moment-picker.min.js"></script>
